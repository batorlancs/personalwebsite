...
function Footer() {
    ...
    return (
        <div className= 'relative bg-black h-20 px-[10%] flex justify-center items-center'>
            <a id='link' href='' download='file' target='_blank' className='h-full w-full flex flex-row gap-2 justify-center items-center opacity-50 duration-500 hover:opacity-80'>
                <img className='invert h-10 cursor-pointer max-lg:h-8 max-sm:h-6' src={DownloadPic}></img>
