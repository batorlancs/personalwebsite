...
function Articles() {
    return (
        <div className='pt-56'>
            <div className='flex flex-row justify-between items-center gap-20 h-72'>
                ...
                <div className='w-full h-full p-10 bg-gray-300 bg-opacity-30 border-white border-4 rounded-3xl shadow-2xl'>
                    <div className='flex flex-row items-center justify-between w-full'>
                        <img className='h-10 w-10 bg-orange-500 bg-opacity-50 rounded-full'></img>
                ...
                <div className='w-full h-full p-10 bg-gray-300 bg-opacity-30 border-white border-4 rounded-3xl shadow-2xl'>
                    <div className='flex flex-row items-center justify-between w-full'>
                        <img className='h-10 w-10 bg-blue-500 bg-opacity-50 rounded-full'></img>
                        <p className='text-lg font-semibold opacity-50'>2 Hours Ago</p>
                    </div>
                    <h3 className='mt-5 text-2xl font-bold'>Article Title of Something</h3>
                    <p className='mt-5 text-xl'>This is a description about the article, a little intro about what it looks like</p>
