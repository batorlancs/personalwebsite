...
const ProjectCard: React.FC<ProjectCardProps> = (props)  => {
    return (
        <div data-aos='fade-up' className='relative flex flex-row items-center min-h-[600px] bg-white backdrop-blur-lg rounded-3xl bg-opacity-0 mt-24 gap-20
            max-xl:gap-10 max-md:flex-col max-md:bg-opacity-30 max-md:shadow-xl max-sm:mt-5 max-sm:min-h-0 max-sm:gap-5'>
            ...
            <div className='flex flex-col h-full items-start justify-center w-full max-md:px-6 max-md:pb-12'>
