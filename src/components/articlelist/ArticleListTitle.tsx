	...
	return (
        <div className="mb-16">
            ...
            <div className="mt-5 flex flex-row items-center justify-start gap-5">
                <div className="h-3 w-9 rounded-full bg-opacity-50 bg-emerald-600"></div>
                <p className="text-xl font-terminal text-emerald-600 max-sm:text-base">articles about tech</p>
            </div>
